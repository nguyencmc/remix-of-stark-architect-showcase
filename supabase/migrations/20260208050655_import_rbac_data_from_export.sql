-- =============================================
-- RBAC DATA IMPORT FROM ORIGINAL PROJECT
-- Generated at: 2026-02-08T04:56:50.314Z
-- Tables: 6
-- =============================================

-- Clean up data seeded by previous migration (wrong IDs)
-- Must delete role_permissions first due to FK constraint
...
-- -----------------------------------------------
-- Table: user_roles - SKIPPED (references old auth.users that don't exist in new project)
-- The admin role for nguyenvnu.uet@gmail.com was already granted via migration 20260208043547
-- -----------------------------------------------
...
-- -----------------------------------------------
-- Table: audit_logs (25 rows) - SKIPPED
-- References old user_id bd8a70eb-ecbe-433d-817f-c3f2bf2f94a7 which doesn't exist in new project.
-- audit_logs.user_id has FK REFERENCES auth.users(id) ON DELETE SET NULL, so INSERT would fail.
-- -----------------------------------------------

-- -----------------------------------------------
-- Table: user_achievements (2 rows) - SKIPPED
-- References old user_id bd8a70eb-ecbe-433d-817f-c3f2bf2f94a7 which doesn't exist in new project.
-- -----------------------------------------------


-- =============================================
-- SUMMARY: Imported 211 rows from 4 tables (permissions: 78, role_permissions: 115, achievements: 18)
-- SKIPPED: user_roles (1 row), audit_logs (25 rows), user_achievements (2 rows) - old user_id references
-- =============================================